...
<sub>或 [下载单文件版](https://github.com/MrSenter/cijing/releases/latest) 双击离线玩（一个 html，图和发音全打包）· 手机/平板见下方<br>⚠️ 下载单文件版暂为中／英，**西语目前只在上方在线版**</sub>
...
**2026-07 · 西班牙语上线（第三语言）**
- **西语成为一等语言**：可学西语，也可当母语（整套界面、场景目录、地图、词卡全西语）。861 词配西语词、音标、例句、内置神经 TTS 发音。中／英／西 任意配对。
...
**2026-07 · 多语言 + 面板 + 移动端**
- **多语言**：可选母语和学习语言（中／英／西），一键互换方向；中文侧带拼音、英文/西语侧带音标
